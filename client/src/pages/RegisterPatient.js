  ...
  const submitHandler = async (inputs) => {
    try {
      ...
      const resp = await axios.post(
        "https://ai-powered-geriatric-care.onrender.com/api/v1/patient/register",
        inputs
      );
  ...
  return (
    <div className="register-patient-page">
            ...
            <Col lg={8}>
              <div className="hero-content p-4 rounded-lg">
                <div className="animated-icon-container mb-3">
                  <IdcardOutlined className="animated-icon" />
                </div>
              ...
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  <div className="floating-icon-circle mx-auto">
                    <IdcardOutlined className="fs-1 text-white" />
                  </div>
                  <h2 className="gradient-text mb-3">Patient Registration</h2>
                ...
                {loading ? (
                  ...
                  >
                    <Form.Item
                      label={<span className="form-label">Patient Name</span>}
                      name="pName"
                      rules={[
                    ...
                    >
                      <Input
                        prefix={<FieldTimeOutlined className="text-primary" />}
                        type="date"
                        className="fancy-input"
                      />
                    </Form.Item>
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={12}>
                        <Form.Item
                          label={<span className="form-label">Diabetic</span>}
                          name="diabetic"
                          initialValue={false}
                        >
                          <Select
                    ...
                    <Form.Item
                      label={<span className="form-label">Hypertension</span>}
                      name="hypertension"
                      initialValue={false}
                    >
                      <Select
                    ...
                    <Form.Item
                      label={<span className="form-label">Guardian Phone</span>}
                      name="guardianPhone"
                    >
                      <Input
                    ...
                    <Form.Item
                      label={<span className="form-label">Hospital Email</span>}
                      name="hospitalEmail"
                    >
                      <Input
                        prefix={<MailOutlined className="text-primary" />}
                    ...
                    <Form.Item
                      label={<span className="form-label">Doctor Email</span>}
                      name="doctorEmail"
                    >
                      <Input
                        prefix={<MailOutlined className="text-primary" />}
                    ...
                    <Form.Item className="mb-3">
                      <button className="btn-glow w-100 py-3" type="submit">
                        <span className="btn-text">Register as Patient</span>
                      </button>
                    </Form.Item>
                  </Form>
                )}
      ...
      <style jsx>{`
        ...
        .register-patient-page .hero-section-animated {
          background: linear-gradient(135deg, #0061ff, #60efff);
          position: relative;
          overflow: hidden;
        }

        .register-patient-page .animated-bg {
          position: absolute;
          top: 0;
          left: 0;
          right: 0;
        ...
        .register-patient-page .hero-content {
          position: relative;
          z-index: 2;
        }

        .register-patient-page .glow-text {
        ...
        .register-patient-page .highlight-text {
        ...
        .register-patient-page .animated-icon-container {
          height: 80px;
          width: 80px;
          display: flex;
          align-items: center;
        ...
        .register-patient-page .animated-icon {
          font-size: 2.5rem;
          color: white;
        }

        /* Enhanced Registration Card */
        .register-patient-page .registration-card-enhanced {
          position: relative;
          overflow: hidden;
          border-radius: 20px;
        ...
        .register-patient-page .color-bar-animated {
          height: 8px;
        ...
        .register-patient-page .floating-icon-circle {
          width: 80px;
          height: 80px;
          border-radius: 50%;
          background: linear-gradient(135deg, #0061ff, #60efff);
        ...
        .register-patient-page .gradient-text {
        ...
        .register-patient-page .form-label {
          color: #495057;
          font-weight: 600;
          font-size: 0.9rem;
        }

        .register-patient-page .fancy-input,
        .register-patient-page .fancy-select {
          height: 50px;
          border-radius: 10px;
        ...
        .register-patient-page .fancy-input:focus,
        .register-patient-page .fancy-input:hover,
        .register-patient-page .fancy-select:focus,
        .register-patient-page .fancy-select:hover {
          border-color: #0061ff;
          box-shadow: 0 0 0 3px rgba(0, 97, 255, 0.1);
        }

        .register-patient-page .btn-glow {
          border: none;
          border-radius: 12px;
          background: linear-gradient(90deg, #0061ff, #60efff);
          color: white;
        ...
        .register-patient-page .btn-glow:before {
          content: "";
          position: absolute;
          top: 0;
          left: -100%;
        ...
        .register-patient-page .btn-glow:hover {
          transform: translateY(-3px);
          box-shadow: 0 8px 25px rgba(0, 97, 255, 0.4);
        }

        .register-patient-page .btn-text {
          position: relative;
          z-index: 2;
        }

        .register-patient-page .divider-fancy {
          display: flex;
          align-items: center;
          text-align: center;
          color: #8e94a3;
        ...
        .register-patient-page .divider-fancy::before,
        .register-patient-page .divider-fancy::after {
          content: "";
          flex: 1;
        ...
        .register-patient-page .btn-outline-fancy {
          padding: 12px 24px;
        ...
        .register-patient-page .btn-outline-fancy::before {
          content: "";
          position: absolute;
          top: 0;
          right: 0;
        ...
        .register-patient-page .btn-outline-fancy:hover {
          background: linear-gradient(90deg, #0061ff, #60efff);
          color: white;
        ...
        /* Benefits Section */
        .register-patient-page .benefits-section {
          padding: 50px 0;
          background: #f8f9ff;
        }

        .register-patient-page .benefit-card {
          background: white;
          border-radius: 16px;
          padding: 30px;
          text-align: center;
        ...
        .register-patient-page .benefit-card-1 {
          border-color: #0061ff;
        }

        .register-patient-page .benefit-card-2 {
          border-color: #4adede;
        }

        .register-patient-page .benefit-card-3 {
          border-color: #60efff;
        }

        .register-patient-page .benefit-card:hover {
          transform: translateY(-10px);
          box-shadow: 0 15px 35px rgba(0, 0, 0, 0.1);
        }

        .register-patient-page .benefit-icon {
          font-size: 2.5rem;
          margin-bottom: 15px;
          color: #0061ff;
          height: 70px;
        ...
        .register-patient-page .benefit-card h4 {
          color: #0061ff;
          margin-bottom: 15px;
          font-weight: 600;
        }

        .register-patient-page .benefit-card p {
          color: #6c757d;
        }
      `}</style>
    </div>
